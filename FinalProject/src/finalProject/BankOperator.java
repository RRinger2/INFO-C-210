...
public class BankOperator {
	...
	public static void main(String[] args) {
		...
		// display created accounts after removing account3
		System.out.println("Displaying updated accounts list.");
		for (Account account : accounts) {
			account.displayInfo();
		}
